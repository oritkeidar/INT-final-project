...
function LogOut() {
    ...
    var _b = AuthProvider_1.useAuthContext(), dispatchAuthContext = _b.dispatch, isLoggedIn = _b.isLoggedIn;
                    ...
                    deactivateSession = function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            apiClients_1["default"]
                                .post("http://localhost:4000/logout", {}, { withCredentials: true })["finally"](function () {
    ...
    }); }, [dispatchAuthContext, isLoggedIn]);
