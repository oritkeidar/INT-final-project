...
exports.accountContext = react_1.createContext({});
exports.AccountProvider = function (_a) {
    var children = _a.children;
    var _b = react_1.useState({}), accountData = _b[0], setAccountData = _b[1];
    ...
    return (react_1["default"].createElement(exports.accountContext.Provider, { value: [accountData, setAccountData, getDataFromServer] }, children));
};
